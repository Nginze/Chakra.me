...
const Hero = ({ community, isAdmin }) => {
  ...
  const [joined, setJoined] = useState(
    community &&
      user &&
      _find(community.members, member => {
  ...
  return (
    <div
      style={{
        background: `url(${community?.communityBannerBlurred})`,
        backgroundSize: "cover",
      }}
      id="hero"
    >
      <div
        className="unblured-img "
        style={{
      ...
      <div className="h_container">
        ...
        <div className="h_cta">
          <div
            ...
            id="post-sorter"
          >
            <button onClick={() => setShow(!show)} className="h_settings">
              <span
                class="iconify"
                data-icon="cil:options"
                data-width="30"
                data-rotate="90deg"
              ></span>
            </button>
            <div
              ...
              id="leave"
              className="options animate__animated animate__zoomIn animate__faster"
            >
              ...
              {!j_loading ? (
                ...
                >
                  <span
                    ...
                    class="iconify"
                    data-icon="tabler:layout-grid-add"
                    data-width="20"
                  ></span>
                  <span>Follow Space</span>
                </span>
              ) : (
                <ClipLoader color={"white"} loading={j_loading} size={10} />
              )}
            </button>
          )}
          {joined && (
