  ...
  return (
    <div id="space-side-bar">
      <div id="d-section">
        ...
        >
          <div className="d-desc">{community?.communityDesc}</div>
          ...
          <div className="d-cta">
            <span style={{ display: "flex", alignItems: "center" }}>
              <span
                ...
                class="iconify"
                data-icon="fluent:food-cake-12-regular"
                data-width="15"
              ></span>
      ...
      <div id="d-section">
        <div className="d-header">
          <span style={{ fontWeight: "500" }}>
            {" "}
            {community?.communityName}'s Rules{" "}
            {isAdmin && (
              <i
                onClick={() => setShowRulesModal(!show)}
                style={{ marginLeft: "0.4rem", cursor: "pointer" }}
                class="fa-solid fa-pen"
              ></i>
            )}
              ...
              <div className="s_profile">
                ...
                <div>
                  ...
                  >
                    {admin.userName}
                    <span
                      style={{ marginLeft: "0.3rem", color: "#9e9ea0" }}
                      class="iconify"
                      data-icon="cil:shield-alt"
                    ></span>
                  </span>
