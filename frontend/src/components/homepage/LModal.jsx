...
const LModal = ({show, toggle}) => {
 ...
 show && <>
    ...
    <div id='l-modal' className={show ? ' animate__animated animate__fadeInRight animate__faster' : ' animate__animated animate__fadeOutRight animate__faster'}>
        ...
        <div className='ct'>
            <button onClick={() => login()} className='google-btn'><img src="https://img.icons8.com/color/48/000000/google-logo.png"/> <div>Google</div></button>
