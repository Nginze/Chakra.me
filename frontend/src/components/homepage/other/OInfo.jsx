        ...
        <div className='p-meta-container'>
            ...
            <div className='p-meta'>
                ...
                <h2 className='p-meta-name'>
                  {user.userName} 
                  {!followingState?.isFollowing ? <button onClick={submitFollow} className='post-btn follow-btn'>
                  ...
                  :<div style={{display: 'flex', marginLeft: '1rem',position: 'relative'}}>
                        ...
                        {showUnfollow && <div className='unfollow animate__animated animate__zoomIn animate__faster'>
