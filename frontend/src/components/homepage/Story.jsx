...
const Story = ({toggle, setStories, increaseIndex}) => {
    ...
    const submitView = async (id) => {
        ...
        await axios({method: 'put',url: `http://localhost:5000/story/view/${id}`,withCredentials: true, data: {userId: user._id}})
         ...
         <main class="main">
                ...
                {    
                                user?.storyInbox
                                    ...
                                    <div className={story?.views?.includes(user._id) ?`stories__item` :`stories__item stories__item--active`}>
          ...
          return section
      }));toggle(true);submitView(story._id);createNotfication('viewed your story', story)}}>
