...
const Profile_Card = ({ userId }) => {
  ...
  const { data: profile } = useQuery(["profile-card", userId], () => {
  ...
  return (
    <>
      <div
        ...
        className="profile-card animate__animated animate__zoomIn animate__faster"
      >
        ...
        >
          ...
          <span style={{ marginBottom: "0.4rem" }}>
            <i style={{ color: "#707173" }} class="fa-solid fa-user-group"></i>
            <span style={{ marginRight: "0.4rem", marginLeft: "0.4rem" }}>
              •
            </span>
